...
const services=[
    ...
    },
    {
        ...
        description:"Combining frontend and backend development for end-to-end solutions."
    },
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg-cols-3 gap-8'>
            {services.map((service) => (
                <div key={service.id} className='bg-gray-800 p-6 rounded-lg hover:shadow-lg transform transition-transform duration-300 hover:scale-105'>
                    <div className="text-right 2x1 font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-400">
                        {service.id}
                    </div>
